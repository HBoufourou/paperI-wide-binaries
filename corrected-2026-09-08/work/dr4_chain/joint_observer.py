# Derived from the frozen dr4_binary epoch operator; see OBSERVER_PROTOCOL.md.
...
def observe_pairs(wide_v_kms,distance_pc,pm_err_masyr,inner=None,
    ...
    names=['pm','bias_noise','inner_bias','noise','outer']
    ...
    for start in range(0,n,batch_size):
        ...
        for b,m,g in ((34,n3,g3),(66,len(t),g4)):
            ...
            out[f'bias_noise{b}_masyr'][sl]=offset-wb
            out[f'inner_bias{b}_masyr'][sl]=ib
            out[f'noise{b}_masyr'][sl]=offset-ib-wb
